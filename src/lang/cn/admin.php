...
$content['LN_ADMIN_ERROR_NOTALLOWED'] = "不允许使用您的用户级别访问此页面";
$content['LN_DELETEYES'] = "是";
$content['LN_DELETENO'] = "不";
...
$content['LN_UPDATE_INSTALLEDVER'] = "已安装版本: ";
...
$content['LN_GEN_DEBUGGRIDCOUNTER'] = "显示调试网格计数器";
$content['LN_GEN_SHOWPAGERENDERSTATS'] = "显示页面渲染统计信息";
$content['LN_GEN_ENABLEGZIP'] = "开启 GZIP 压缩输出";
$content['LN_GEN_DEBUGUSERLOGIN'] = "调试用户登录";
...
$content['LN_GEN_STRCHARLIMIT'] = "字段中显示的字符数";
...
$content['LN_GEN_CUSTBTNSRCH'] = "自定义搜索字符";
...
$content['LN_GEN_ACCESSDENIED'] = "拒绝对此功能的访问";
...
$content['LN_GEN_SUPPRESSDUPMSG'] = "禁止重复的消息";
$content['LN_GEN_TREATFILTERSTRUE'] = "将未找到字段的筛选器视为确定";
...
$content['LN_GEN_DISABLEADMINUSERS'] = "禁用普通用户的 \"管理员\" 面板";
...
$content['LN_USER_SETISREADONLY'] = "切换 \"仅读\" 状态";
...
$content['LN_GROUP_WARNDELETEGROUP'] = "你确认删除这个 '%1 用户组吗'? 所有组设置也会被删除.";
...
$content['LN_GROUP_ERROR_USERIDMISSING'] = "缺少用户ID";
...
$content['LN_GROUP_USER_ADD'] = "将用户添加到组";
...
$content['LN_SEARCH_SELGROUPENABLE'] = ">> 选择要启用的组 <<";
$content['LN_SEARCH_ERROR_DISPLAYNAMEEMPTY'] = "显示名不能为空.";
$content['LN_SEARCH_ERROR_SEARCHQUERYEMPTY'] = "搜索查询不能为空";
...
$content['LN_SEARCH_ERROR_INVALIDID'] = "无效的搜索ID.";
...
$content['LN_CHARTS_ENABLED'] = "已启用图表";
...
$content['LN_FIELDS_DEFAULTWIDTH'] = "列表视图中的行宽度";
...
$content['LN_FILTER_TYPE_STRING'] = "字符";
$content['LN_FILTER_TYPE_NUMBER'] = "数字";
